...
#2%
\hfill$\qexsymbol$\par\egroup\medbreak
}
%%}}}
...
\global\advance\maxhintno by 1\relax%
\fi
\ifnum\hintno=1% add a label upon first hint
...
% solution
\def\solution##1\par{%
\immediate\writesolution{problem}{\number\chapterno}{\problemtag}{\unexpanded{##1}}%
}%
#2%
#3%
\printhintstatus%
